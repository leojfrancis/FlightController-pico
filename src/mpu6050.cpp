...
int mpu6050_init(mpu6050_inst_t* inst, i2c_inst_t* i2c, uint pin) {
    ...
    quaternion_t initial_roll = {
        .w = cos((float)(angle_x_accel * MPU6050_RADIANS_PER_DEGREE * 0.5)), 
        .x = sin((float)(angle_x_accel * MPU6050_RADIANS_PER_DEGREE * 0.5)),
        .y = 0.0001,
        .z = 0.0001
    };
    ...
    quaternion_t initial_pitch = {
        .w = cos((float)(angle_y_accel * MPU6050_RADIANS_PER_DEGREE * 0.5)), 
        .x = 0.0001, 
        .y = sin((float)(angle_y_accel * MPU6050_RADIANS_PER_DEGREE * 0.5)), 
        .z = 0.0001 
    };
